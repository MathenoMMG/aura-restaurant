  ...
  'inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold tracking-wide backdrop-blur-md transition-colors',
  {
    variants: {
      variant: {
        ...
        scale: 'bg-stone-800/80 text-stone-200 border border-stone-700 font-mono text-[10px]',
...
export const Badge: React.FC<BadgeProps> = ({ className, variant, icon, children, ...props }) => {
  return (
