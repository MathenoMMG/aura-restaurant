...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-2xl font-bold transition-all duration-200 active:scale-95 cursor-pointer disabled:opacity-50 disabled:pointer-events-none select-none',
  {
    variants: {
      variant: {
        primary: 'bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-stone-950 shadow-[0_0_25px_rgba(245,158,11,0.3)]',
        secondary: 'bg-stone-900/90 hover:bg-stone-800 text-stone-200 border border-stone-800 backdrop-blur-md',
        glass: 'bg-stone-950/70 hover:bg-stone-900/80 text-stone-100 border border-white/10 backdrop-blur-xl',
