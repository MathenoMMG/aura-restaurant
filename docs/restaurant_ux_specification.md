...
2. **Atmósfera Dark Gourmet & Anti-Slop:** Fondos en negro obsidiana profundo (`#08090A`), acentos en oro champán mate (`#E5C378`), superficies de vidrio ahumado (_glassmorphism_ `backdrop-blur: 24px`) y tipografía serif editorial de alta costura (_Cormorant Garamond_ / _Playfair Display_).
